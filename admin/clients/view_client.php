    ...
    <div class="card card-outline card-primary shadow-sm">
        <div class="card-header">
            ...
            <div class="card-tools">
                ...
                <!-- NEW BUTTON: Add New Job (Transaction) with client pre-selected -->
                <button type="button" class="btn btn-sm btn-flat btn-primary" onclick="location.href='./?page=transactions/manage_transaction&client_id=<?= $id ?>'">
