...
<div class="card card-outline card-navy shadow">
    <div class="card-header no-print">
        <h3 class="card-title font-weight-bold">
            <a href="./?page=mechanics/salary_management" class="btn btn-sm btn-default border mr-2" title="Back to Salary List">
    ...
    <div class="card-body">
        <div class="filter-container no-print">
            <form id="filter-form" class="row align-items-end justify-content-center">
                <input type="hidden" name="page" value="attendance/view_mechanic_ledger">
                <input type="hidden" name="id" value="<?php echo $mid ?>">
                <div class="col-auto">
                    <a href="./?page=attendance/view_mechanic_ledger&id=<?php echo $mid ?>&from=<?php echo $prev_month_from ?>&to=<?php echo $prev_month_to ?>" class="nav-arrow" title="Previous Month"><i class="fa fa-chevron-left"></i></a>
                </div>
                <div class="col-md-3">
                ...
                <div class="col-auto">
                    <a href="./?page=attendance/view_mechanic_ledger&id=<?php echo $mid ?>&from=<?php echo $next_month_from ?>&to=<?php echo $next_month_to ?>" class="nav-arrow" title="Next Month"><i class="fa fa-chevron-right"></i></a>
                </div>
            </form>
        </div>
