    ...
    <div class="container-fluid mt-4 mb-5">
        ...
        <div class="mt-5 mb-4 text-center">
            ...
            <p class="text-muted">
                ...
                <?php 
                $month_names = ['January' => 'जनवरी', 'February' => 'फरवरी', /* Add all months */]; // Add full mapping if needed
                $filter_month_int = $filter_month;
                if ($filter_type == 'monthly') {
                    echo isset($month_names[date('F', mktime(0,0,0,$filter_month,1))]) ? $month_names[date('F', mktime(0,0,0,$filter_month,1))] . " $filter_year" : $filter_month . " $filter_year";
                } elseif ($filter_type == 'yearly') {
